...
const unsigned int MD5::A = 0x67452301,MD5::B = 0xefcdab89, MD5::C = 0x98badcfe, MD5::D = 0x10325476;
...
{
	unsigned int tempA = A, tempB = B, tempC = C, tempD = D, strlength = 0;
